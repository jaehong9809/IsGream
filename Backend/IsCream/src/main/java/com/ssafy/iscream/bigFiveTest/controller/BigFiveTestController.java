...
public class BigFiveTestController {
    ...
    public ResponseEntity<?> getBigFivePDF(@Login User user, @PathVariable("big-five-test-id") Integer bigFiveTestId) {
        String pdfUrl = bigFiveTestService.getBigFivePdfUrl(user, bigFiveTestId).get("url");
        try {
            ...
            return ResponseEntity.ok()
                    .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=bigfive_test_" + bigFiveTestId + ".pdf")
