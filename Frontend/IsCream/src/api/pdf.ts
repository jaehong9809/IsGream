...
export const pdfApi = {
    // HTP 검사 pdf 추출
    async pdfHTP(testId: number): Promise<GetResultToPdfResponse> {
        try {
    ...
    // PAT  검사 pdf 추출
    async pdfPat(testId: number): Promise<GetResultToPdfResponse> {
        try {
    ...
    // Big five 검사 pdf 추출
    async pdfBigFive(testId: number): Promise<GetResultToPdfResponse> {
        try {
