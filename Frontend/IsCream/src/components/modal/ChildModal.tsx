...
const ChildeModal: React.FC<ChildeModalProps> = ({isOpen, onClose, onSubmit, initialData}) => {
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                onChange={(e) => setChildData({...childData, childNickname: e.target.value})}
                        ...
                        <div className="mb-4">
                            ...
                            <select
                                ...
                                onChange={(e) => setChildData({...childData, childSex: e.target.value})}
                                className="w-full border p-2 rounded"
                            >
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                max={today}
                                onChange={(e) => setChildData({...childData, childBirth: e.target.value})}
                                className="w-full border p-2 rounded"
                            />
                        </div>
